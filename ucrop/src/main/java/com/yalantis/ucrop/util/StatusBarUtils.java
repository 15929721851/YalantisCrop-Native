...
public class StatusBarUtils {
    ...
    public static void setNavigationBarColor(Activity context, int colorId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            context.getWindow().setNavigationBarColor(context.getResources().getColor(colorId));
        }
    }
    ...
    public static StatusBarUtils utils;

    public static StatusBarUtils getUtils() {
        if (utils == null) {
            utils = new StatusBarUtils();
        }
        return utils;
    }
